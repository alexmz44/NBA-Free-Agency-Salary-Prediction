...
fa_df$`Player (190)` <- word(fa_df$`Player (190)`, 2, sep = "    ")
head(fa_df)

# rename the player column
fa_df <- fa_df %>%
  rename(Player = `Player (190)`)
...
Now, the data is tidy, and it now time to do the fun part. We have to begin building the model. This begins with recognizing what variables we should be choosing in order to build a solid model.
